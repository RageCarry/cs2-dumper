...
namespace cs2_dumper {
    namespace interfaces {
        ...
        namespace navsystem_dll {
            constexpr std::ptrdiff_t  = 0xFFFF8002B0760007;
        }
        // Module: networksystem.dll
        namespace networksystem_dll {
            constexpr std::ptrdiff_t  = 0xFFFF8002A5C20007;
        ...
        namespace panoramauiclient_dll {
            constexpr std::ptrdiff_t  = 0xFFFF8002A7B10007;
        }
        ...
        namespace scenefilecache_dll {
            constexpr std::ptrdiff_t  = 0xFFFF80029BED0007;
        }
        ...
        namespace steamclient64_dll {
            ...
            constexpr std::ptrdiff_t p2pvoice002 = 0xD6E17;
        ...
        namespace v8system_dll {
            constexpr std::ptrdiff_t  = 0xFFFF800267D00007;
        }
